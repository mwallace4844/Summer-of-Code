# Summer-of-Code
 ...
 3. AttributeError: 'Game' object has no attribute 'time_formatted' - it totally does, I do not understand this error. I think it's a problem with the play again.
## How to run my code
